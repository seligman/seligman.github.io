...
# Please see https://seligman.github.io/podcasts/nevernotfunny/nevernotfunny.html to search online.
...
def download_data(num, start, len, is_gzip=True, get_size=False, decode_json=True, ignore_cache=False):
    ...
    url = f"https://seligman.github.io/podcasts/nevernotfunny/search_data_{num:02d}.dat"
